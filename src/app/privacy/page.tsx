const PRIVACY_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      "Service providers may process face data only as necessary to provide the app's analysis, hosting, storage, authentication, payment, or support functionality",
